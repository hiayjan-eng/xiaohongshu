...
if (manifest.manifest_version !== 3 || manifest.version_name !== "0.4.2-m0-api-spike") throw new Error("M0 API spike must be MV3 version 0.4.2-m0-api-spike");
...
for (const marker of ["M0_API_PROBE_MAIN_READY", "M0_API_PROBE_BRIDGE_READY", "createProbeSession", "M0_API_PROBE_RECORD", "M0_API_SYNC_CONFIRM", "DYNAMIC_SIGNATURE_REQUIRED", "api-sync/api-sync-idb.js"]) if (!background.includes(marker)) throw new Error(`Missing safety marker: ${marker}`);
