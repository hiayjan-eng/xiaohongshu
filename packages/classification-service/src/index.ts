...
export const DOMAIN_SUBDOMAINS: Record<ContentDomain, string[]> = {
  ...
  "AI 与效率": ["AI工具", "Prompt 工程", "自动化工作流", "软件教程", "决策辅助", "办公效率"],
...
const prototypes: Prototype[] = [
  ...
  p("AI 与效率", "AI工具", "AI 工具、Codex、ChatGPT、Claude 等工具用法", "tool", ["AI工具", "Codex", "ChatGPT", "Claude", "Gemini"], ["AI", "工具", "代码助手", "模型", "插件", "智能体", "生成"], ["3个方法让 Codex 帮你干活", "AI工具日常工作流入门", "用 ChatGPT 整理资料"], ["AI公司招聘"]),
